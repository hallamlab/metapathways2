...
try:
   ...
   from libs.python_modules.pipeline.metapathways_pipeline import print_commands, call_commands_serially
...
########################### BEFORE BLAST ########################################
#################################################################################
def run_metapathways_before_BLAST(s, input_fp, output_dir, all_samples_output_dir, globallogger,  command_handler, command_line_params, params, metapaths_config, status_update_callback, config_file, ncbi_sequin_params, ncbi_sequin_sbt, run_type, config_settings = None):
    ...
    #stepslogger = WorkflowLogger(generate_log_fp(output_dir, basefile_name = 'metapathways.eps_log'),open_mode='w')
    #errorlogger = WorkflowLogger(generate_log_fp(output_dir, basefile_name='errors[s.warnings_log'),open_mode='w')
...
###########################  BLAST ##############################################
#################################################################################
def run_metapathways_at_BLAST(s, input_fp, output_dir, all_samples_output_dir, globallogger, command_handler, command_line_params, params, metapaths_config, status_update_callback, config_file, ncbi_sequin_params, ncbi_sequin_sbt, run_type, config_settings = None):
...
def run_metapathways_after_BLAST(s, input_fp, output_dir, all_samples_output_dir, globallogger,  command_handler, command_line_params, params, metapaths_config, status_update_callback, config_file, ncbi_sequin_params, ncbi_sequin_sbt, run_type, config_settings = None):
